...
caffevis_caffe_root      = '/home/dashixianxian/caffe/'
...
static_files_dir = 'input_images/cell'
...
# use vgg
model = 'vgg'
caffevis_deploy_prototxt = root_dir + '/models/caffenet-yos/VGG_ILSVRC_19_layers_deploy.prototxt'
caffevis_network_weights = root_dir + '/models/caffenet-yos/VGG_ILSVRC_19_layers.caffemodel'
global_font_size = .5  # for better view
# use alexnet
# model = 'alexnet'
# caffevis_deploy_prototxt = root_dir + '/models/caffenet-yos/caffenet-yos-deploy.prototxt'
# caffevis_network_weights = root_dir + '/models/caffenet-yos/bvlc_reference_caffenet.caffemodel'
